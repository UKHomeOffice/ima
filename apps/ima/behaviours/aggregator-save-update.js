...
//   deleteItem(req, res) {
//     return res.redirect(`${req.baseUrl}/${req.form.options.deleteStep}/delete/${req.params.id}`);
//   }
...
//       const id = req.params.id;
//       const items = this.getAggregateArray(req);
//       let currentCountryArray = req.sessionModel.get('harm-country-state');

//       //console.log("Current state last",currentCountryArray)
//        if (items[id]) {
